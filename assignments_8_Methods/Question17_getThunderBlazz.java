...
public class Question17_getThunderBlazz {
	...
	public static void main(String[] args) {
		...
		getThunderBlazz(false, false, 3, 1, 5);
		
		
	}
	
	public static void getThunderBlazz(boolean available, boolean gift, int ingredient1 , int ingredient2, int ingredient3) {
...
There are a few ways to get this galacticly popular drink if it is available 
at the store you can buy it. or you can get it as a gift.
